...
def run_install(project_path: str | None = None, global_mode: bool = False) -> int:
    ...
    print()
    print("Done! Skills installed (auto-invoked by Claude):")
    print("  /neander-status        - Active and recent sessions")
    print("  /neander-search        - Search across sessions")
    print("  /neander-transcript    - Condensed transcript view")
    print("  /neander-summarize     - AI summary of a session")
    print("  /neander-session-stats - Token usage, costs, file stats")
    print("  /neander-redact        - Scan and redact secrets (user-invoked only)")
    print()
    print("CLI commands also available:")
    print("  neander-checkpoints status")
    print("  neander-checkpoints search <query>")
    print("  neander-checkpoints transcript <id>")
    print("  neander-checkpoints stats <id>")
    print("  neander-checkpoints resume <id>")
    print()
