...
echo "Done! Installed:"
echo ""
echo "  Skills (Claude auto-invokes based on conversation):"
echo "    /neander-status        — Checkpoints overview"
echo "    /neander-search        — Search checkpoints"
echo "    /neander-transcript    — View transcript"
echo "    /neander-summarize     — AI summary with caching"
echo "    /neander-session-stats — Token usage, costs"
echo "    /neander-redact        — Scan for secrets (user-invoked only)"
echo ""
echo "  CLI (run in terminal):"
echo "    neander-checkpoints resume <checkpoint-id>"
echo ""
